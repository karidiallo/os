export const categories = [
  {id:"money",label:"Ruch finansowy",desc:"sprzedaż, przychód, odzyskanie pieniędzy, płatności"},
  ...
  {id:"body",label:"Ciało",desc:"trening, zdrowie, jedzenie, ruch"},
...
export function newDay() {
  return {
    ...
    capacity:{score:0,percent:0,mode:"standard",label:"Dzisiaj robimy dzień standardowy.",copy:""},
    top3:["","",""], moneyMove:"",
...
export function defaults() {
  return {
    ...
    ideas:[],proof:[],reviews:[],financeSnapshots:{},bodyLogs:{}
  };
}
